<template>
    <div class="icon-temperature" :class="{on: isOn}">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path class="fill-variable" d="M12,23c-3.3,0-6-2.7-6-6c0-1.6,0.7-3.2,1.9-4.4c0.2-0.2,0.6-0.6,0.6-1.1v-7C8.5,2.6,10.1,1,12,1
            ...
            <path class="fill-const" d="M11.5,11v0.5c0,1.5-0.8,2.6-1.6,3.3C9.4,15.4,9,16.1,9,17c0,1.7,1.3,3,3,3s3-1.3,3-3c0-0.9-0.4-1.6-0.9-2.2

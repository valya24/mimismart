<template>
	<div class="icon-lamp-rings" :class="{on: isOn}">
		<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path fill-rule=evenodd clip-rule=evenodd class="fill-variable" d="M18,20.5c1.5-0.9,2-1.8,2-2.5s-0.5-1.6-2-2.5c-1.4-0.9-3.6-1.5-6-1.5c-2.5,0-4.6,0.6-6,1.5

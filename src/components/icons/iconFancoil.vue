<template>
	<div class="icon-alarm" :class="{
		...
		<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path class="fill-const part-coil" d="M22,0v2c0,0.6-0.4,1-1,1h-4.6c1,0.5,2,1.2,2.8,2H21c1.7,0,3-1.3,3-3V0H22z M4.9,5H3C2.4,5,2,5.4,2,6
			...
			<path class="fill-variable part-fan" d="M20.3,11c-0.7-0.8-1.8-1.2-2.8-1l-2.2,0.5l0.5-1.2c0.5-1.1,0.4-2.3-0.1-3.4c-0.5-1.1-1.5-1.9-2.6-2.2

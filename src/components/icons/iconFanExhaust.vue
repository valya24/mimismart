<template>
	...
	>
		<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path class="fill-const" d="M12,3H3v2h3.3C7.9,3.7,9.9,3,12,3z M17.7,5H21V3h-9C14.1,3,16.1,3.7,17.7,5z M4.5,7H3v2h0.5
			...
			<path id="fan" class="fill-variable part-fan" d="M12,20c2.7,0,4-1.4,4-3.3c0-1.4-0.8-3.2-2.3-4.7H20c0-2.7-1.4-4-3.3-4c-1.4,0-3.2,0.8-4.7,2.3V4
				C9.3,4,8,5.4,8,7.3c0,1.5,0.8,3.2,2.3,4.7H4c0,2.7,1.5,4,3.3,4c1.5,0,3.2-0.8,4.7-2.3L12,20L12,20z"/>
			<path class="fill-variable" d="M20,24H4c-2.2,0-4-1.8-4-4V4c0-2.2,1.8-4,4-4h16c2.2,0,4,1.8,4,4v16C24,22.2,22.2,24,20,24z M4,2

<template>
	<div class="icon-alarm" :class="{on: isOn}">
		<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path class="fill-const" d="M10,6h4c0.6,0,1,0.4,1,1l0,0c0,0.6-0.4,1-1,1h-4C9.4,8,9,7.6,9,7l0,0C9,6.4,9.4,6,10,6z M10,0L10,0
			...
			<path class="fill-variable" d="M15.7,24H8.3c-0.9,0-1.7-0.4-2.2-1c-0.6-0.6-0.8-1.5-0.7-2.4l1.2-10C6.7,9.1,8,8,9.5,8h5

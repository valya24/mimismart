<template>
    <div class="icon-close" :class="{on: isOn}">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path class="fill-variable" d="M22.5,12H18v-2h4V4c0-0.6-0.4-1-1-1H3C2.4,3,2,3.4,2,4v6h4v2H1.5C0.7,12,0,11.3,0,10.5V4c0-1.7,1.3-3,3-3h18
                c1.7,0,3,1.3,3,3v6.5C24,11.3,23.3,12,22.5,12z"/>
            <path class="fill-const" d="M18,12H6c-1.1,0-2-0.9-2-2s0.9-2,2-2h12c1.1,0,2,0.9,2,2S19.1,12,18,12z M16,4h4c0.6,0,1,0.4,1,1l0,0

<template>
	<div class="icon-alarm" :class="{on: isOn}">
		<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			<path class="fill-variable" d="M11,0.5c-0.6,0-1,0.4-1,1v1.6l-1.4-1C8.1,1.9,7.5,2,7.2,2.4C6.9,2.9,7,3.5,7.4,3.8L10,5.5v4.7
				...
				V0.5z"/>
			<path class="fill-variable" d="M12,24L12,24L12,24L12,24z M13,21.2l0.6-1.7c-0.2,0-0.4,0.1-0.6,0.1V21.2z M13,17.9
